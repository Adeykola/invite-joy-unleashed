      ...
      <header className="sticky top-0 z-40 w-full border-b bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
        <div className="container flex h-16 items-center justify-between">
          <div className="flex items-center">
            <Link to="/" className="text-xl font-bold text-brand-primary mr-8">
              RSVPlatform
            </Link>
                  ...
                  <NavigationMenuItem key={item.name}>
                    <Link to={item.href}>
                      <NavigationMenuLink className={cn(
                        navigationMenuTriggerStyle(),
                        location.pathname === item.href && "bg-brand-light text-brand-primary"
                      )}>
                        {item.name}
                      </NavigationMenuLink>
                    </Link>
            ...
            <SheetContent side="right">
              <div className="flex flex-col h-full">
                ...
                <nav className="flex flex-col gap-4 py-6">
                  {navigation.map((item) => (
                    <Link
                      ...
                      to={item.href}
                      className={cn(
                        "text-lg font-medium px-2 py-1 hover:text-brand-primary",
                        location.pathname === item.href && "text-brand-primary font-semibold"
                      )}
                    >
                      {item.name}
                    </Link>
                ...
                <div className="mt-auto border-t py-6 space-y-4">
                  {user ? (
                    <Button className="w-full bg-brand-primary hover:bg-brand-primary/90" asChild>
                      <Link to="/user-dashboard">Dashboard</Link>
                    </Button>
                  ) : (
                    <>
        ...
        <div className="container mx-auto py-12 px-4 sm:px-6 lg:py-16">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm text-brand-light">
                ...
                <li><Link to="/events" className="hover:text-brand-accent transition-colors">Browse Events</Link></li>
              </ul>
            </div>
            <div>
              ...
              <ul className="space-y-2 text-sm text-brand-light">
                ...
                <li><Link to="#" className="hover:text-brand-accent transition-colors">Blog</Link></li>
                <li><Link to="#" className="hover:text-brand-accent transition-colors">API Documentation</Link></li>
              </ul>
            </div>
            <div>
              <h3 className="text-lg font-semibold mb-4">Company</h3>
              <ul className="space-y-2 text-sm text-brand-light">
                <li><Link to="#" className="hover:text-brand-accent transition-colors">About</Link></li>
          ...
          <div className="border-t border-white/20 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex space-x-6 mt-4 md:mt-0">
              <Link to="#" className="text-brand-light hover:text-brand-accent">
